...
library(readr)
eval = read.csv("Group 6 Evaluations.csv", stringsAsFactors = FALSE)
```
...
cat(paste('-', eval$What.did.you.like.most.about.the.presentation.[-22]), sep = '\n') 
```

#### What areas might you suggest for improvement not listed above?

```{r, echo=FALSE, results='asis'}
cat(paste('-', eval$What.areas.might.you.suggest.for.improvement.not.listed.above.[-22]), sep = '\n')
```
...
- Very good project and excellent presentation! Bravo!